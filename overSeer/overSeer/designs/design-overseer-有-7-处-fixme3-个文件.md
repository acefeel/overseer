...
tags:
  ...
  - bug
status: active
title: Design - overSeer 有 7 处 FIXME（3 个文件）
createdAt: '2026-07-05T00:50:31.256Z'
---
## 背景
示例：
  ...
  - vault/overSeer/designs/design-overseer-有-2-处-fixme1-个文件.md:10 （1 个文件）
  - vault/overSeer/designs/design-overseer-有-2-处-fixme1-个文件.md:21 ，按文件聚类

共 7 处。建议归类处理或迁入 issue tracker。
