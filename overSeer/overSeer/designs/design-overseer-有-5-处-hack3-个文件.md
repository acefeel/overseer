...
tags:
  ...
  - tech-debt
status: active
title: Design - overSeer 有 5 处 HACK（3 个文件）
createdAt: '2026-07-05T00:51:40.022Z'
---
## 背景
示例：
  ...
  - vault/overSeer/designs/design-overseer-有-3-处-hack2-个文件.md:10 （2 个文件）
  - vault/overSeer/designs/design-overseer-有-3-处-hack2-个文件.md:22 ，按文件聚类
  - src/scanners/todo.ts:60 'medium',

共 5 处。建议归类处理或迁入 issue tracker。
